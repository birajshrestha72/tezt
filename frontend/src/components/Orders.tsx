  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Orders & Sales</h1>
          <p className="text-gray-600 text-sm mt-1">Manage customer orders and inventory</p>
        </div>
        <button
          onClick={handleCreate}
          className="w-full md:w-auto flex items-center justify-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700"
        >
          <Plus size={20} />
          Create Order
        </button>
      ...
      {/* Error Alert */}
      {error && (
        <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg flex items-gap-2">
                    ...
                    <tr key={order.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 text-center space-x-2">
                        <button
                          ...
                          className="text-blue-600 hover:text-blue-700 inline-block p-2"
                          title="Edit"
                        >
                          <Edit2 size={18} />
                        </button>
                        <button
                          ...
                          className="text-red-600 hover:text-red-700 inline-block p-2"
                          title="Delete"
                        >
                          <Trash2 size={18} />
                        </button>
              ...
              return (
                <div key={order.id} className="p-4 space-y-3">
                  ...
                  <div className="flex gap-2 pt-2 border-t">
                    <button
                      onClick={() => handleEdit(order)}
                      className="flex-1 flex items-center justify-center gap-2 bg-blue-50 text-blue-600 px-3 py-2 rounded text-sm hover:bg-blue-100"
                    >
                      <Edit2 size={16} />
                      Edit
                    </button>
                    <button
                      onClick={() => setDeleteConfirm({ isOpen: true, orderId: order.id })}
                      className="flex-1 flex items-center justify-center gap-2 bg-red-50 text-red-600 px-3 py-2 rounded text-sm hover:bg-red-100"
                    >
                      <Trash2 size={16} />
                      Delete
                    </button>
